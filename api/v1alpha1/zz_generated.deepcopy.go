...
func (in *CertificatesSpec) DeepCopyInto(out *CertificatesSpec) {
	*out = *in
	if in.RootCACertificateDuration != nil {
		in, out := &in.RootCACertificateDuration, &out.RootCACertificateDuration
		*out = new(v1.Duration)
		**out = **in
	}
	if in.CACertificateDuration != nil {
		in, out := &in.CACertificateDuration, &out.CACertificateDuration
		*out = new(v1.Duration)
		**out = **in
	}
}
